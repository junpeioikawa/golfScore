...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('house_id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('house_name', models.CharField(max_length=255)),
                ('house_zipcode', models.CharField(max_length=8)),
                ('house_prefecture', models.CharField(max_length=40)),
                ('house_city', models.CharField(max_length=100)),
                ('house_address', models.CharField(max_length=255)),
                ('house_phone_number', models.CharField(max_length=11)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('update_at', models.DateTimeField(auto_now=True)),
                ('course_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='golfScore_app.coursemaster')),
            ],
        ),
        migrations.CreateModel(
            name='Score',
